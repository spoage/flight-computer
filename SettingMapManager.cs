...
{
    public class SettingMapManager
    {
        ...
        public SettingMapManager(string filename = null)
        {
        ...
        public void LoadFromFile(bool clearBeforeReload = true)
        {
            ...
            if (File.Exists<FlightComputer>(this.SettingsFile))
            {
                ...
                string[] settingLines = File.ReadAllLines<FlightComputer>(this.SettingsFile);
        ...
        public void SaveToFile()
        {
            if (this._writeNeeded)
            {
                ...
                if (this._values.Count > 0 && File.Exists<SettingMapManager>(this.SettingsFile))
                {
                    TextWriter file = File.CreateText<SettingMapManager>(this.SettingsFile);
